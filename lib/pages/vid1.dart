...
class Vid1 extends StatefulWidget {
  final List values3;
  Vid1({Key key, @required this.values3}) : super(key: key);
  @override
...
Future createUser() async {
  ...
  final String apiUrl =
      "http://18.216.220.165/i-switch/fireready/update_video1.php";
...
class _VidState extends State<Vid1> {
  int video1_details;
  List values3;
  ...
  void initState() {
    ...
    var temp = double.parse(sess_obj.video['video1']);
    video1_details = temp.toInt();
    print("video class");
    print(video1_details);
    controller = new Controller(
      items: [
        new PlayerItem(
          startAt:
              Duration(seconds: video1_details == null ? 0 : video1_details),
          title: '1',
      ...
      playerItem: (playerItem) {
        ...
        postData = {
          ...
          'phone': values3[1],
          // 'title': values3[2],
          'video1': playerItem.position.inSeconds.toString(),
